...
const testimonials = [
  {
    quote: "The moment my mother recognized her childhood friend again. That's when I knew this was worth building.",
    author: "Jake Kang",
    role: "Hackathon Winner",
    company: "ForgetMeNot Team",
    metric: { value: "1st", label: "Place, MongoDB Hackathon" },
  },
  {
    quote: "A system that learns what matters about someone. Every conversation makes the next one richer.",
    author: "Cognee Team",
    role: "Memory Graph Platform",
    company: "Supporting Innovation",
    metric: { value: "4/4", label: "Lifecycle APIs Used" },
  },
  {
    quote: "The reminder card appears in seconds. No friction, just presence and warmth.",
    author: "Test Family",
    role: "Early User",
    company: "Private Testing",
    metric: { value: "<2s", label: "End-to-End Latency" },
  },
  {
    quote: "With one click, you can remove someone from the system entirely. Privacy and dignity by design.",
    author: "Privacy Advocate",
    role: "User Research",
    company: "Feedback Contributor",
    metric: { value: "100%", label: "Data Deletion" },
  },
];
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              Built for people
              <span className="text-background/40"> who forget, and those who love them.</span>
            </h2>
          </div>
