...
const steps = [
  {
    ...
    title: "Enroll",
    subtitle: "a person",
    description: "Capture one or two webcam frames of someone you care about. Backend computes face embeddings and stores starter facts in Cognee's memory.",
    code: `await cognee.remember(
  'Sarah, my daughter. Works in tech.',
  session_id=personId
)`,
  },
  {
    ...
    title: "Recall",
    subtitle: "instantly",
    description: "Point the camera at someone. Face matches against your enrolled contacts. One WebSocket call retrieves memories and renders a card on their face.",
    code: `results = await cognee.recall(
  query='What do I know?',
  session_id=personId
)
// 'Sarah, software engineer at...'`,
  },
  {
    number: "03",
    title: "Improve",
    subtitle: "over time",
    description: "Each encounter distills into the knowledge graph. Raw notes become permanent facts. Cognee's improve() API enriches the graph so memory gets sharper with use.",
    code: `await cognee.remember(
  'mentioned gardening again',
  session_id=personId
)
await cognee.memify()
// Graph now reflects this pattern`,
  },
];
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block">Enroll.</span>
              <span className="block text-white/30">Recall.</span>
              <span className="block text-white/10">Improve.</span>
            </h2>
          </div>
