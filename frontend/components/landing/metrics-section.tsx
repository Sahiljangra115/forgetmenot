...
const metrics = [
  { 
    ...
    sublabel: "on known contacts",
  },
  { 
    value: 4, 
    suffix: "/4", 
    prefix: "",
    label: "Memory Lifecycle APIs",
    sublabel: "remember, recall, improve, forget",
  },
  { 
    value: 2, 
    suffix: "s", 
    ...
    sublabel: "face match to memory display",
  },
];
...
export function MetricsSection() {
  ...
  const [isVisible, setIsVisible] = useState(true); // ponytail: same fix, default visible
  ...
  return (
    <section id="impact" ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      <GridBackground />
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20 lg:mb-32">
          <div className="lg:col-span-8 lg:col-start-1">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[140px] font-display tracking-tight leading-[0.95] transition-all duration-1000 ${
              ...
              Real-time
              <br />
              <span className="text-muted-foreground">memory metrics.</span>
            </h2>
          </div>
        </div>
        ...
        <div className={`mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground transition-all duration-1000 delay-500 ${
          ...
          <span>remember()</span>
          <span>recall()</span>
          <span>improve() / memify</span>
          <span>forget()</span>
          <span className="text-foreground">the full Cognee lifecycle</span>
        </div>
      </div>
    </section>
  );
