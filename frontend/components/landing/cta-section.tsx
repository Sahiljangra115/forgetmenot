            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              ...
              <div className="flex-1">
                ...
                <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-xl">
                  ForgetMeNot turns a smartphone camera into a personal memory assistant. Built on Cognee's knowledge graph, it helps those with memory loss stay connected to the people who matter.
                </p>
                ...
                <p className="text-sm text-muted-foreground mt-8 font-mono">
                  Open source. Built with Cognee. Available now.
                </p>
              </div>
