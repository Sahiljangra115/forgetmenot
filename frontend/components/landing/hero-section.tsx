...
const words = ["remember", "recall", "improve", "care"];
...
export function HeroSection() {
  const [isVisible, setIsVisible] = useState(true); // ponytail: default to true to ensure text is always visible on network/mobile links even if hydration/js execution is delayed
    ...
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-white/60">
            ...
            Agentic memory for dementia care
          </span>
        </div>
        ...
        <div className="mb-12">
          ...
          >
            <span className="block whitespace-nowrap">Memory that</span>
      ...
      >
        <div className="max-w-[1400px] mx-auto flex items-start gap-10 lg:gap-20">
          {[
            { value: "100%", label: "face recognition accuracy" },
            { value: "4/4", label: "memory lifecycle APIs used" },
            { value: "<2s", label: "recall latency" },
          ].map((stat) => (
