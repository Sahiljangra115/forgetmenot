...
const securityFeatures = [
  {
    ...
    description: "Enroll a person deliberately. No passive collection.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Surgical deletion",
    description: "One-click forget() removes all traces of a person forever.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Transparent API calls",
    description: "Every memory operation logged visibly in the UI.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Privacy-preserving recall",
    description: "Face recognition happens locally. Graph queries scoped per person.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["Cognee-powered memory", "Client-side face matching", "Open source", "Auditable by design"];
        ...
        <div className="mb-20">
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              A face is sensitive data, and dementia already takes enough from the people who trust us with theirs.
              ForgetMeNot only remembers what you let it remember, and forgets on request, completely.
            </p>
          </div>
        </div>
